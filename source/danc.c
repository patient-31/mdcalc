...
none	dc_error_exit(i_H *mess, iP_1 error_type, t_calculate *strct, p_cleanup_function cleanup)
{
...
error	dc_ERROR_MEM(t_calculate *o, i_H *mess)
{
...
error	dc_ERROR_MEM_index(t_calculate *o, i_H *mess, iP_1 v1, iP_1 v2, iP_1 v3)
{
	FILE *err = fopen("error.txt", "a");
...
dP_2	dc_find_result_mdcalc(iP_1 tkount, ...)
{
	va_list	arg;
	dP_2	result;
